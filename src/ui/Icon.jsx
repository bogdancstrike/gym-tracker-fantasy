...
export const Icon = {
  ...
  skull:     (p) => sloIcon(<><path d="M9 10L9 12M15 10L15 12" /><circle cx="12" cy="12" r="9" /><path d="M8 15C8 15 9 18 12 18C15 18 16 15 16 15" /></>, p),
  barbell:   (p) => sloIcon(<><path d="M6 12H18M6 8V16M18 8V16M3 9V15M21 9V15" /></>, p),
  target:    (p) => sloIcon(<><circle cx="12" cy="12" r="10" /><circle cx="12" cy="12" r="6" /><circle cx="12" cy="12" r="2" /></>, p),
};
